...
<html>
  <body>
	...
	if (!$result)
	{
		error_log("Failed to insert new item in database. MySQL reports '".mysql_error($link)."' while querying 'INSERT INTO items VALUES (NULL, \"$name\", \"$description\", $initialPrice, $quantity, $reservePrice, $buyNow, '$start', '$end', $userId, $categoryId)': ");
